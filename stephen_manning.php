...
<html>
	...
	<body>
		<div id="wrapper">
			<div id="leftPanel" class="ourPeople-lawyers">
				<?php include 'includes/sitewide-mainNavMenu1.php'; ?>
			</div>
			<div id="midPanel" class="mlw">
				...
				<div class="moreInfoLink">
					<a href="pdf/mark_l_wheeler_072713.pdf" target="_blank">More Information</a>
				</div>
			</div>
			<div id="rightPanel" class="mlw-rightPanel"></div>
		</div>
	</body>
</html>
