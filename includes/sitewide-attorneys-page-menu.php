<ul class="lawyerList1">
	<li class="dropdown-header">Members:</li>
	<li><a href="stephen-j-bean.php" title="Stephen J. Bean">Stephen J. Bean</a></li>
	<li><a href="fred-gentry.php" title="Fred D. Gentry">Fred D. Gentry</a></li>
	...
	<li class="dropdown-header">Associates:</li>
	<li><a href="ann-c-harrie.php" title="Ann C. Harrie">Ann C. Harrie</a></li>
        <li><a href="anne-wilson.php" title="Anne Wilsond">Anne Wilson</a></li>
	...
	<li><a href="cheryl-duryea.php" title="Cheryl Duryea">Cheryl L. Duryea</a></li>
</ul>