...
<html lang="en">
    <head>
        ...
        <title>Bean, Gentry, Wheeler &amp; Peternell, PLLC - Appellate, Trial And Legal Ethics Consulting</title>
    ...
    <body>
        <div id="wrapper">
            ...
            <div class="right-panel practice-type">
                <article>
                    <section>
                        <h1>Appellate, Trial And Legal Ethics Consulting</h1>
                       
                        <ul>
                            <li>Appellate matters</li>
							<li>Ethics consulting</li>
