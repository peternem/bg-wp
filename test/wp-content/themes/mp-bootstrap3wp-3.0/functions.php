 ...
 * @return void
 */
function bootstrap3wp_setup() {

	require 'inc/general/class-Bootwp_Walker_Nav_Menu.php';

	load_theme_textdomain('bootstrap3wp', get_template_directory().'/languages');
	
	add_theme_support( 'automatic-feed-links' );

	register_nav_menus( array('primary' => __( 'Primary Menu', 'Bootstrap WP Primary' ),) );
...
add_action( 'after_setup_theme', 'bootstrap3wp_setup' );

/**
 * Register widgetized area and update sidebar with default widgets
 */
 
function bootstrap3wp_widgets_init() {
...
add_action( 'widgets_init', 'bootstrap3wp_widgets_init' );

function bootstrap3wp_scripts() {
	...
	wp_enqueue_script( 'bootwp-jQuery', get_template_directory_uri().'/js/jquery.js',array(),'2.0.3',true);
	wp_enqueue_script( 'bootwp-basefile', get_template_directory_uri().'/js/bootstrap.min.js',array(),'20130905',true);
}
add_action( 'wp_enqueue_scripts', 'bootstrap3wp_scripts' );
...
function bootstrap3wp_breadcrumbs() {
