<?php
/**
 * Template Name: Page - Branding Portfolio No Tabs
...
<?php while (have_posts()) : the_post(); ?>
	...
	<div class="jumbotron site-tabs">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<h2>A sample of my Branding Work.</h2>
				</div>
			</div>
			<?php
			$args = array( 'category' => 2, 'posts_per_page' => 6, 'offset'=> 0,'orderby' => 'post_date', 'order' => 'ASC');
