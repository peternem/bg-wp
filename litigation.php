...
<html lang="en">
    <head>
        ...
        <title>Bean Gentry Wheeler &amp; Peternell PLLC - Litigation</title>
        ...
        <div id="wrapper">
            ...
            <div class="right-panel practice-type">
                <article>
                    <section>
                        <h1>Litigation</h1>
                        <p>Representation in all areas of defense and plaintiff litigation, except domestic relations and criminal matters. </p>
                    </section>
                </article>
            </div>
        </div>
